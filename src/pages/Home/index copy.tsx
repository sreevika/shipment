...
let ups_originalRows: UpsShipment[] = [];
let ups_originalRows_backup: UpsShipment[] = [];
...
export default function HomePage() {
  ...
  // useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        let response :any=[]
        if(mainNavigation === "fedex") {
           response = await axios.get(
            `${EDUCONNECT_URL}/Dashboard/${mainNavigation}?fromDate=${formatDate(
              fromDate,
              dateFormatForDb
          ...
          originalRows_backup = response.data.data;
           ...
           response = await axios.get(
            `${EDUCONNECT_URL}/Dashboard/${mainNavigation}?fromDate=2023-06-29&toDate=2023-07-23&levelName=AWGGL&surName=dfw`,
            config
          );

          ups_originalRows = response.data.data;
          ups_originalRows_backup = response.data.data;
  ...
  // ----------------------- ups ----------------------------------------------
  //const ups_totalRecords =ups_originalRows_backup.length;
