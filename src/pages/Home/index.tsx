  ...
  const applyFilter = () => {
    ...
    if (filter_model.includes("deliveredDate")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__deliveredDate.includes(
    ...
    if (filter_model.includes("accountNo")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__accountNo.includes(item.accountNumber)
      );
    }

    if (filter_model.includes("noOfAttempt")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__attemptDelivery.includes(item.numberOfAttemptedDeliveries)
      );
    }

    if (filter_model.includes("packageKg")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__packageKg.includes(item.packageWeightKg)
      );
    }

    if (filter_model.includes("packageLbs")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__packageLbs.includes(item.packageWeightLbs)
      );
    }
    if (filter_model.includes("purchaseOrderNumber")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__purchaseOrderNo.includes(item.purchaseOrderNumber)
      );
    }

    if (filter_model.includes("reference")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter__reference.includes(item.reference)
      );
    }

    if (filter_model.includes("scheduledDeliveryDate")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter_scheduledDeliveryDate.includes(
          moment(
    ...
    if (filter_model.includes("shipDate")) {
      filteredData_level1 = filteredData_level1.filter((item) =>
        filter_shipDate.includes(item.shipDate)
      );
    }
                            ...
                            <div className="filter-section-btn-icon">
                              <label className="checkbox">
                                <input
                                  ...
                                  onChange={shipperChange}
                                  value="delivered"
                                  checked={userinfo.includes("delivered")}
                                />
                                <span className="checkbox-indicator">
                                  <svg
                                    width="17"
                            ...
                            <div className="filter-section-btn-icon">
                              <label className="checkbox">
                                <input
                                  ...
                                  onChange={shipperChange}
                                  value="exception"
                                  checked={userinfo.includes("exception")}
                                />
                                <span className="checkbox-indicator">
                                  <svg
                                    width="17"
                            ...
                            <div className="filter-section-btn-icon">
                              <label className="checkbox">
                                <input
                                  ...
                                  onChange={shipperChange}
                                  value="inTransit"
                                  checked={userinfo.includes("inTransit")}
                                />
                                <span className="checkbox-indicator">
                                  <svg
                                    width="17"
                            ...
                            <div className="filter-section-btn-icon">
                              <label className="checkbox">
                                <input
                                  ...
                                  onChange={shipperChange}
                                  value="label"
                                  checked={userinfo.includes("label")}
                                />
                                <span className="checkbox-indicator">
                                  <svg
                                    width="17"
                ...
                <Table aria-label="shipping table" className="filter-table">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="left">
                        <button className="filter-table__header filter-table__header--button">
                          <div className="filter-table__title">Pkg Wt (Kg)</div>
                          <div className="filter-table__sort-icon desending">
                            <svg
                              width="10"
                              height="5"
                      ...
                      <TableCell align="left">
                        <button className="filter-table__header filter-table__header--button">
                          <div className="filter-table__title">Shipped by </div>
                          <div className="filter-table__sort-icon desending">
                            <svg
                              width="10"
                              height="5"
                  ...
                  <TableBody>
                    {rows.map((row) => (
                      <TableRow key={row.trackingNumber}>
                        ...
                        <TableCell align="left">{row.shippedBy}</TableCell>
                        <TableCell align="left">{row.shipperAddress}</TableCell>
                        <TableCell align="left">{row.shipperCountry}</TableCell>
                        <TableCell align="left">{row.shipperPostal}</TableCell>
                        <TableCell align="left">
                          {row.specialHandling}
                        </TableCell>
                        <TableCell align="left">{row.serviceType}</TableCell>
                        <TableCell align="left">{row.packageCount}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
