            ...
            <form className="form-elm" onSubmit={handleLogin}>
              ...
              <div className="form-outline mb-3 wrapper" id="form-outline-password">
                <div className="lockIcon">
                  ...
                  {showPassword ? 
                   <VisibilityIcon sx={{ fontSize: 24, marginTop: 2, marginLeft: 38, color: 'grey' }} onClick={toggleShowPassword} /> : 
                  <RemoveRedEyeOutlinedIcon sx={{ fontSize: 24, marginTop: 2, marginLeft: 38, color: 'grey' }} onClick={toggleShowPassword} /> }
